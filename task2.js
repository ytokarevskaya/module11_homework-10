...
// Задание выполнено верно. Но есть большая просьба - не используйте пожалуйста сторонние библиотеки, если это прямо не указано в задании. Это сильно усложняет проверку, потому что мне приходится настраивать среду и устанавливать соответствующие модули, чтобы всё работало.